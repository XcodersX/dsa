...
public class TreeDBX {
    ...
    public static void main(String[] args) throws NonExistingBookException {

        BinarySearchTree searchTree = new BinarySearchTree();
        List<Book> books = new ArrayList();
        BookJpaController bookJp = new BookJpaController();
        books = bookJp.findBookEntities();
        searchTree.add(books);
        try {
       ...
       /*Book book = new Book();
        ...
        book2_2.setIsbn(31);
        book2_2.setTitle("Bonus book");
        
        Book book2_3 = new Book();
        book2_3.setIsbn(32);
        book2_3.setTitle("Pokemon");
        ...
        System.out.println("@************************************************");
        //bst.inOrder();
         List<Book> allBooks = bst.find("batma"); //bst.findAll();
